  ...
  <v-app class="elevation-2" style="border:1px solid #424242;max-height:100vh">
    <v-container style="height:calc(100% - 2px)" class="overflow-y-auto">
      ...
      <v-btn
        ...
        style="bottom: 6px; right: 65px"
        icon="mdi-printer"
      >
      <v-badge  content="2" floating color="primary">
        <v-icon></v-icon>
      </v-badge>
      </v-btn>
      <v-btn
      ...
      position="absolute"
      class="v-btn--example"
      @click.prevent="imprimir_solo"
      style="bottom: 6px; right: 8px"
      icon="mdi-printer-outline"
      >
      <v-badge  content="1" floating color="primary">
        <v-icon></v-icon>
      </v-badge>
      </v-btn>
    </v-container>
...
function imprimir() {
  window.electron.reimprimirRecibo(2)
}
function imprimir_solo() {
  window.electron.reimprimirRecibo(1)
}
function cerrar() {
 window.electron.closeReciboReimprimir()
}
